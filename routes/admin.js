...
router.post('/posts/new', eAdmin, (req, res) => {
    ...
    // Vou linkar isso aqui porque essa quantidade de ifs imediatamente me fez
    // pensar em um jeito melhor de fazer isso. Acho que você vai gostar.
    // Algo como mapear os erros possíveis e fazer algum tipo de pattern matching
