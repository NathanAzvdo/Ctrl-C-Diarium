...
router.post("/posts/new", eAdmin, function (req, res) {
  ...
  const validations = {
    Title: {
      condition: !req.body.Title || req.body.Title.length < 3,
      message: "Título inválido!",
    },
    Slug: {
      condition: !req.body.Slug,
      message: "Slug inválido!",
    },
    Cont: {
      condition: !req.body.Cont || req.body.Cont < 10,
      message: "Conteúdo inválido!",
    },
    Desc: {
      condition: !req.body.Desc || req.body.Desc.length < 5,
      message: "Descrição inválida!",
    },
    Categoria: {
      condition: req.body.Categoria === "0",
      message: "Registre uma categoria!",
    },
  };
...
router.post("/categorias/new", eAdmin, function (req, res) {
  ...
  const validations = {
    Name: {
      condition: !req.body.Name || req.body.Name.length < 2,
